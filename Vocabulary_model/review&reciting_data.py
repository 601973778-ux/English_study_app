...
from Vocabulary_model.learned_words_store import LEARNED_WORDS_FILE, LearnedWordsFileStore
...
class ReviewRecitingDataStore:
    ...
    def count_learned_words(self, wordbook_id: str | None = None) -> int:

        return len(self._file.list_words(wordbook_id=wordbook_id))

    def list_learned_words(self, wordbook_id: str | None = None) -> list[str]:

        return self._file.list_words(wordbook_id=wordbook_id)
    ...
    def record_self_rating(
        ...
        self, word: str, choice: str, wordbook_id: str | None = None

    ) -> dict[str, object]:

        return self._file.record_self_rating(word, choice, wordbook_id=wordbook_id)
    ...
    def get_self_rating_window(
        ...
        return self._file.get_self_rating_window(word, wordbook_id=wordbook_id)
